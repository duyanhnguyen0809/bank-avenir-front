      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              href="/accounts"
              className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all cursor-pointer group"
            >
              <CreditCard className="h-8 w-8 text-blue-600 group-hover:scale-110 transition-transform" />
              <div>
            ...
            <Link
              href="/trading"
              className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:border-green-300 hover:bg-green-50 transition-all cursor-pointer group"
            >
            ...
            <Link
              href="/loans"
              className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-all cursor-pointer group"
            >
              <DollarSign className="h-8 w-8 text-purple-600 group-hover:scale-110 transition-transform" />
              <div>
